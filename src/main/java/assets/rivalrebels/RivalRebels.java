...
import assets.rivalrebels.common.core.*;
...
public class RivalRebels// extends DummyModContainer
{
    ...
    private void registerItems(RegistryEvent.Register<Item> event) {
        ...
        int nextNum = 0;
        // TODO: add coherent names
        rpg = (new ItemRPG()).setRegistryName("rivalrebelsitem" + (nextNum++));
        flamethrower = (new ItemFlameThrower()).setRegistryName("rivalrebelsitem" + (nextNum++));
        tesla = (new ItemTesla()).setRegistryName("rivalrebelsitem" + (nextNum++));
        rocket = (new ItemRocket()).setRegistryName("rivalrebelsitem" + (nextNum++));
        fuel = (new ItemFuel()).setRegistryName("rivalrebelsitem" + (nextNum++));
        battery = (new ItemBattery()).setRegistryName("rivalrebelsitem" + (nextNum++));
        pliers = (new ItemPliers()).setRegistryName("rivalrebelsitem" + (nextNum++));
        armyshovel = (new ItemArmyShovel()).setRegistryName("rivalrebelsitem" + (nextNum++));
        knife = (new ItemCuchillo()).setRegistryName("rivalrebelsitem" + (nextNum++));
        gasgrenade = (new ItemGasGrenade()).setRegistryName("rivalrebelsitem" + (nextNum++));
        safepill = (new ItemSafePill()).setRegistryName("rivalrebelsitem" + (nextNum++));
        expill = (new ItemExPill()).setRegistryName("rivalrebelsitem" + (nextNum++));
        remote = (new ItemRemote()).setRegistryName("rivalrebelsitem" + (nextNum++));
        fuse = (new ItemFuse()).setRegistryName("rivalrebelsitem" + (nextNum++));
        nuclearelement = (new ItemRodNuclear()).setRegistryName("rivalrebelsitem" + (nextNum++));
        hydrod = (new ItemRodHydrogen()).setRegistryName("rivalrebelsitem" + (nextNum++));
        plasmacannon = (new ItemPlasmaCannon()).setRegistryName("rivalrebelsitem" + (nextNum++));
        roddisk = (new ItemRodDisk()).setRegistryName("rivalrebelsitem" + (nextNum++));
        antenna = (new ItemAntenna()).setRegistryName("rivalrebelsitem" + (nextNum++));
        einsten = (new ItemAstroBlaster()).setRegistryName("rivalrebelsitem" + (nextNum++));
        redrod = (new ItemRodRedstone()).setRegistryName("rivalrebelsitem" + (nextNum++));
        emptyrod = (new ItemRodEmpty()).setRegistryName("rivalrebelsitem" + (nextNum++));
        core1 = (new ItemCoreCopper()).setRegistryName("rivalrebelsitem" + (nextNum++));
        core2 = (new ItemCoreTungsten()).setRegistryName("rivalrebelsitem" + (nextNum++));
        core3 = (new ItemCoreTitanium()).setRegistryName("rivalrebelsitem" + (nextNum++));
        binoculars = (new ItemBinoculars()).setRegistryName("rivalrebelsitem" + (nextNum++));
        chip = (new ItemChip()).setRegistryName("rivalrebelsitem" + (nextNum++));
        // nikolatesla = (new ItemSpreadTesla(nikolateslaID)) .setRegistryName("rivalrebels.items." + (nextNum++));
        roda = (new ItemRoda()).setRegistryName("rivalrebelsitems" + (nextNum++));
        trollmask = (new ItemTrollHelmet()).setRegistryName("rivalrebelsitems" + (nextNum++));
        hackm202 = (new ItemHackM202()).setRegistryName("rivalrebelsitems" + (nextNum++));
        seekm202 = (new ItemSeekM202()).setRegistryName("rivalrebelsitems" + (nextNum++));
        camera = (new ItemCamera()).setRegistryName("rivalrebelsitem" + (nextNum++));

        nextNum = 0;

        registry.register(rpg);
        ...
        registry.register(pliers);
        registry.register(armyshovel);
        registry.register(knife);
        registry.register(gasgrenade);
        registry.register(safepill);
        registry.register(expill);
        registry.register(remote);
        registry.register(fuse);
        registry.register(nuclearelement);
        registry.register(hydrod);
        registry.register(plasmacannon);
        registry.register(roddisk);
        registry.register(antenna);
        registry.register(einsten);
        registry.register(redrod);
        registry.register(emptyrod);
        registry.register(binoculars);
        registry.register(core1);
        registry.register(core2);
        registry.register(core3);
        registry.register(chip);
        // registry.register(nikolatesla, "rivalrebels:item" + nextNum++);
        registry.register(roda);
        registry.register(trollmask);
        registry.register(hackm202);
        registry.register(seekm202);
        registry.register(camera);
        
        registerArmor(registry);
    }
    
    private void registerArmor(IForgeRegistry<Item> registry) {
        ...
        int nextNum = 0;
        orebelhelmet = (new ItemClassArmor(orebelarmor, orebelarmorrenderer, 0, 0, 0).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        orebelchest = (new ItemClassArmor(orebelarmor, orebelarmorrenderer, 1, 0, 0).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        orebelpants = (new ItemClassArmor(orebelarmor, orebelarmorrenderer, 2, 0, 0).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        orebelboots = (new ItemClassArmor(orebelarmor, orebelarmorrenderer, 3, 0, 0).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        onukerhelmet = (new ItemClassArmor(onukerarmor, onukerarmorrenderer, 0, 0, 1).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        onukerchest = (new ItemClassArmor(onukerarmor, onukerarmorrenderer, 1, 0, 1).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        onukerpants = (new ItemClassArmor(onukerarmor, onukerarmorrenderer, 2, 0, 1).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        onukerboots = (new ItemClassArmor(onukerarmor, onukerarmorrenderer, 3, 0, 1).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        ointelhelmet = (new ItemClassArmor(ointelarmor, ointelarmorrenderer, 0, 0, 2).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        ointelchest = (new ItemClassArmor(ointelarmor, ointelarmorrenderer, 1, 0, 2).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        ointelpants = (new ItemClassArmor(ointelarmor, ointelarmorrenderer, 2, 0, 2).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        ointelboots = (new ItemClassArmor(ointelarmor, ointelarmorrenderer, 3, 0, 2).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        ohackerhelmet = (new ItemClassArmor(ohackerarmor, ohackerarmorrenderer, 0, 0, 3).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        ohackerchest = (new ItemClassArmor(ohackerarmor, ohackerarmorrenderer, 1, 0, 3).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        ohackerpants = (new ItemClassArmor(ohackerarmor, ohackerarmorrenderer, 2, 0, 3).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        ohackerboots = (new ItemClassArmor(ohackerarmor, ohackerarmorrenderer, 3, 0, 3).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        srebelhelmet = (new ItemClassArmor(srebelarmor, srebelarmorrenderer, 0, 1, 0).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        srebelchest = (new ItemClassArmor(srebelarmor, srebelarmorrenderer, 1, 1, 0).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        srebelpants = (new ItemClassArmor(srebelarmor, srebelarmorrenderer, 2, 1, 0).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        srebelboots = (new ItemClassArmor(srebelarmor, srebelarmorrenderer, 3, 1, 0).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        snukerhelmet = (new ItemClassArmor(snukerarmor, snukerarmorrenderer, 0, 1, 1).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        snukerchest = (new ItemClassArmor(snukerarmor, snukerarmorrenderer, 1, 1, 1).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        snukerpants = (new ItemClassArmor(snukerarmor, snukerarmorrenderer, 2, 1, 1).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        snukerboots = (new ItemClassArmor(snukerarmor, snukerarmorrenderer, 3, 1, 1).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        sintelhelmet = (new ItemClassArmor(sintelarmor, sintelarmorrenderer, 0, 1, 2).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        sintelchest = (new ItemClassArmor(sintelarmor, sintelarmorrenderer, 1, 1, 2).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        sintelpants = (new ItemClassArmor(sintelarmor, sintelarmorrenderer, 2, 1, 2).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        sintelboots = (new ItemClassArmor(sintelarmor, sintelarmorrenderer, 3, 1, 2).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        shackerhelmet = (new ItemClassArmor(shackerarmor, shackerarmorrenderer, 0, 1, 3).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        shackerchest = (new ItemClassArmor(shackerarmor, shackerarmorrenderer, 1, 1, 3).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        shackerpants = (new ItemClassArmor(shackerarmor, shackerarmorrenderer, 2, 1, 3).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        shackerboots = (new ItemClassArmor(shackerarmor, shackerarmorrenderer, 3, 1, 3).setRegistryName("rivalrebelsarmor" + (nextNum++)));

        int rendererCamo = proxy.addArmor("Camo");
        int rendererCamo2 = proxy.addArmor("Camo2");
        camohat = (new ItemArmorCamo(armorCamo, rendererCamo, 0, 0).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        camoshirt = (new ItemArmorCamo(armorCamo, rendererCamo, 1, 0).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        camopants = (new ItemArmorCamo(armorCamo, rendererCamo, 2, 0).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        camoshoes = (new ItemArmorCamo(armorCamo, rendererCamo, 3, 0).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        camohat2 = (new ItemArmorCamo(armorCamo2, rendererCamo2, 0, 1).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        camoshirt2 = (new ItemArmorCamo(armorCamo2, rendererCamo2, 1, 1).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        camopants2 = (new ItemArmorCamo(armorCamo2, rendererCamo2, 2, 1).setRegistryName("rivalrebelsarmor" + (nextNum++)));
        camoshoes2 = (new ItemArmorCamo(armorCamo2, rendererCamo2, 3, 1).setRegistryName("rivalrebelsarmor" + (nextNum++)));

        nextNum = 0;
        registry.register(orebelhelmet);
        registry.register(orebelchest);
        registry.register(orebelpants);
        registry.register(orebelboots);
        registry.register(onukerhelmet);
        registry.register(onukerchest);
        registry.register(onukerpants);
        registry.register(onukerboots);
        registry.register(ointelhelmet);
        registry.register(ointelchest);
        registry.register(ointelpants);
        registry.register(ointelboots);
        registry.register(ohackerhelmet);
        registry.register(ohackerchest);
        registry.register(ohackerpants);
        registry.register(ohackerboots);
        registry.register(srebelhelmet);
        registry.register(srebelchest);
        registry.register(srebelpants);
        registry.register(srebelboots);
        registry.register(snukerhelmet);
        registry.register(snukerchest);
        registry.register(snukerpants);
        registry.register(snukerboots);
        registry.register(sintelhelmet);
        registry.register(sintelchest);
        registry.register(sintelpants);
        registry.register(sintelboots);
        registry.register(shackerhelmet);
        registry.register(shackerchest);
        registry.register(shackerpants);
        registry.register(shackerboots);
        registry.register(camohat);
        registry.register(camoshirt);
        registry.register(camopants);
        registry.register(camoshoes);
        registry.register(camohat2);
        registry.register(camoshirt2);
        registry.register(camopants2);
        registry.register(camoshoes2);
    }
    ...
    private void registerEntities() {
        ...
        nextNum = -1;
        EntityRegistry.registerModEntity(id("gas_grenade"), EntityGasGrenade.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("cuchillo"), EntityCuchillo.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("propulsion_fx"), EntityPropulsionFX.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 9, true);
        EntityRegistry.registerModEntity(id("passive_fire"), EntityPassiveFire.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 9, true);
        EntityRegistry.registerModEntity(id("rocket"), EntityRocket.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("plasmoid"), EntityPlasmoid.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 400, 1, true);
        EntityRegistry.registerModEntity(id("raytrace"), EntityRaytrace.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("lightning_link"), EntityLightningLink.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("nuclear_blast"), EntityNuclearBlast.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("flame_ball"), EntityFlameBall.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("flame_ball_1"), EntityFlameBall1.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("flame_ball_2"), EntityFlameBall2.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("laptop"), EntityLaptop.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("roddisk_regular"), EntityRoddiskRegular.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("roddisk_rebel"), EntityRoddiskRebel.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("roddisk_officer"), EntityRoddiskOfficer.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("roddisk_leader"), EntityRoddiskLeader.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("tsar_blast"), EntityTsarBlast.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("laser_link"), EntityLaserLink.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("gore"), EntityGore.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("blood"), EntityBlood.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 4, true);
        EntityRegistry.registerModEntity(id("goo"), EntityGoo.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 4, true);
        EntityRegistry.registerModEntity(id("laser_burst"), EntityLaserBurst.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 400, 1, true);
        EntityRegistry.registerModEntity(id("b83"), EntityB83.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("b2_spirit"), EntityB2Spirit.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 400, 1, true);
        EntityRegistry.registerModEntity(id("b2_frag"), EntityB2Frag.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("debris"), EntityDebris.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 3, true);
        EntityRegistry.registerModEntity(id("hack_b83"), EntityHackB83.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("seek_b83"), EntitySeekB83.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("rhodes"), EntityRhodes.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 400, 1, true);
        EntityRegistry.registerModEntity(id("rhodes_head"), EntityRhodesHead.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("rhodes_torso"), EntityRhodesTorso.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("rhodes_left_upper_arm"), EntityRhodesLeftUpperArm.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("rhodes_right_upper_arm"), EntityRhodesRightUpperArm.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("rhodes_left_lower_arm"), EntityRhodesLeftLowerArm.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("rhodes_right_lower_arm"), EntityRhodesRightLowerArm.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("rhodes_left_upper_leg"), EntityRhodesLeftUpperLeg.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("rhodes_right_upper_leg"), EntityRhodesRightUpperLeg.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("rhodes_left_lower_leg"), EntityRhodesLeftLowerLeg.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("rhodes_right_lower_leg"), EntityRhodesRightLowerLeg.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("target"), EntityTarget.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("b83_no_shroom"), EntityB83NoShroom.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("sphere_blash"), EntitySphereBlast.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("nuke"), EntityNuke.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("tsar"), EntityTsar.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("roddisk_rep"), EntityRoddiskRep.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("hot_potato"), EntityHotPotato.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("bomb"), EntityBomb.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("theoretical_tsar"), EntityTheoreticalTsar.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("theoretical_tsar_blast"), EntityTheoreticalTsarBlast.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("flame_ball_green"), EntityFlameBallGreen.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("antimatter_bomb"), EntityAntimatterBomb.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("antimatter_bomb_blast"), EntityAntimatterBombBlast.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("tachyon_bomb_blast"), EntityTachyonBombBlast.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
        EntityRegistry.registerModEntity(id("tachyon_bomb"), EntityTachyonBomb.class, "rivalrebelsentity" + ++nextNum, nextNum, this, 250, 1, true);
    }
