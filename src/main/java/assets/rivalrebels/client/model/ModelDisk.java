...
public class ModelDisk {
    ...
    private final int numOfSegs = 32;
    private final float deg = (float) Math.PI * 2 / numOfSegs;
    private final float cosdeg = (float) Math.cos(deg);
    private final float sindeg = (float) Math.sin(deg);
    ...
    Vertice v9 = new Vertice(cosdeg, 0f, sindeg);
