...
public class ModelTsarBomba {
    private final float[] tsarx = {0.5f, 0.5f, 0.875f, 1f, 1f, 0.875f, 0.5f, 0f};
    private final float[] tsary = {-5f, -3.5f, -2f, -1f, 1f, 2f, 2.75f, 3f};
    private final float[] tsart = {1f, 0.8125f, 0.625f, 0.5f, 0.25f, 0.125f, 0.03125f, 0f};
