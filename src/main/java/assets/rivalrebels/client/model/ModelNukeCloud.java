...
public class ModelNukeCloud {
    private final float[] topx = {0.7f, 1.2f, 1.2f, 1.2f, 1.75f, 2.5f, 3f, 3.5f, 3.5f, 3f, 2.25f, 2f, 1.75f, 1.25f, 0f};
    private final float[] topy = {6.5f, 5f, 6f, 7f, 7.1f, 7.25f, 7.5f, 8.25f, 9f, 9.25f, 9.4f, 9.75f, 10.1f, 10.25f, 10.25f};
    private final float[] bottomx = {1.22f, 1.12f, 1.03f, 0.95f, 0.88f, 0.82f, 0.77f, 0.73f, 0.71f, 0.7f, 0.7f};
    private final float[] bottomy = {-4f, -3f, -2f, -1f, 0f, 1f, 2f, 3.25f, 4.5f, 5.5f, 6.5f};

    private final int segments = 18;
