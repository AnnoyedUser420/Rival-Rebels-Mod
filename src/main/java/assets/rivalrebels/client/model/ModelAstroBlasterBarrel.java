...
public class ModelAstroBlasterBarrel {
    ...
    private final float[] barrelx = {0f, 0.2f, 0.2f, 0.25f, 0.25f, 0.2f, 0f};
    private final float[] barrely = {0f, 0f, 0.2f, 0.2f, 0f, -0.1f, -0.1f};
    private final float[] tsart = {i * 28, i * 24, i * 16, i * 15, i * 7, i * 4, i * 3, 0};
