...
public class RenderRhodes extends Render
{
	...
	public RenderRhodes()
	{
    	...
    	head = ModelLoader.loadModel(new ResourceLocation(RivalRebels.MODID, "models/rhodes/head.obj"));
    	torso = ModelLoader.loadModel(new ResourceLocation(RivalRebels.MODID, "models/rhodes/torso.obj"));
    	flag = ModelLoader.loadModel(new ResourceLocation(RivalRebels.MODID, "models/rhodes/flag.obj"));
    	upperarm = ModelLoader.loadModel(new ResourceLocation(RivalRebels.MODID, "models/rhodes/upperarm.obj"));
    	lowerarm = ModelLoader.loadModel(new ResourceLocation(RivalRebels.MODID, "models/rhodes/lowerarm.obj"));
    	flamethrower = ModelLoader.loadModel(new ResourceLocation(RivalRebels.MODID, "models/rhodes/flamethrower.obj"));
    	rocketlauncher = ModelLoader.loadModel(new ResourceLocation(RivalRebels.MODID, "models/rhodes/rocketlauncher.obj"));
    	thigh = ModelLoader.loadModel(new ResourceLocation(RivalRebels.MODID, "models/rhodes/thigh.obj"));
    	shin = ModelLoader.loadModel(new ResourceLocation(RivalRebels.MODID, "models/rhodes/shin.obj"));
    	flame = ModelLoader.loadModel(new ResourceLocation(RivalRebels.MODID, "models/rhodes/flame.obj"));
    	laser = ModelLoader.loadModel(new ResourceLocation(RivalRebels.MODID, "models/rhodes/laser.obj"));
    	booster = ModelLoader.loadModel(new ResourceLocation(RivalRebels.MODID, "models/booster.obj"));
    	
    	ffhead = ModelLoader.loadModel(new ResourceLocation(RivalRebels.MODID, "models/rhodes/ffhead.obj"));
    	fftorso = ModelLoader.loadModel(new ResourceLocation(RivalRebels.MODID, "models/rhodes/fftorso.obj"));
    	ffupperarm = ModelLoader.loadModel(new ResourceLocation(RivalRebels.MODID, "models/rhodes/ffupperarm.obj"));
    	fflowerarm = ModelLoader.loadModel(new ResourceLocation(RivalRebels.MODID, "models/rhodes/fflowerarm.obj"));
    	ffthigh = ModelLoader.loadModel(new ResourceLocation(RivalRebels.MODID, "models/rhodes/ffthigh.obj"));
    	ffshin = ModelLoader.loadModel(new ResourceLocation(RivalRebels.MODID, "models/rhodes/ffshin.obj"));
