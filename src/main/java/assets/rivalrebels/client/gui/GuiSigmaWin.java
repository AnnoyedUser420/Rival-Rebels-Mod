...
public class GuiSigmaWin extends GuiScreen {
    ...
    public void drawScreen(int x, int y, float d) {
        drawCenteredString(fontRenderer, I18n.translateToLocal("RivalRebels.sigmawin.subtitle"), (this.width / 2), (this.height / 2 - 120), 0xffffff);
        float scalefactor = 4f;
        GlStateManager.scale(scalefactor, scalefactor, scalefactor);
        drawCenteredString(fontRenderer, I18n.translateToLocal("RivalRebels.sigmawin.title"), (int) ((this.width / 2) / scalefactor), (int) ((this.height / 2 - 100) / scalefactor), 0xffffff);
