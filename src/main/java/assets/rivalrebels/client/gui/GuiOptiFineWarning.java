...
public class GuiOptiFineWarning extends GuiScreen
{
	...
	public void drawScreen(int x, int y, float d)
	{
		...
		tessellator.draw();
		// drawCenteredString(fontRendererObj, "Please deinstall OptiFine to view the Rival Rebels Force-Fields properly.", (int) (this.width / 2), (int) (this.height / 2 - 120), 0xffffff);
