    ...
    private void renderBinoculars(ItemStack item, RenderGameOverlayEvent event, EntityPlayer player) {
        if (Mouse.isButtonDown(1)) {
            ...
            if (event.type == ElementType.HOTBAR) {
                ...
                if (ItemBinoculars.tooFar)
                    fr.drawString(StatCollector.translateToLocal("RivalRebels.controller.range"), (int) ((w * 0.5) - (fr.getStringWidth(StatCollector.translateToLocal("RivalRebels.controller.range")) / 2f)), (int) (h * 0.85), 0xff0000, false);
                else if (ItemBinoculars.tooClose)
                    fr.drawString(StatCollector.translateToLocal("RivalRebels.nextbattle.no"), (int) ((w * 0.5) - (fr.getStringWidth(StatCollector.translateToLocal("RivalRebels.nextbattle.no")) / 2f)), (int) (h * 0.85), 0xff0000, false);
                    //else if (dist2 < 40)
                    //{
                    ...
                    fr.drawString(StatCollector.translateToLocal("RivalRebels.binoculars.target"), (int) ((w * 0.5) - (fr.getStringWidth(StatCollector.translateToLocal("RivalRebels.binoculars.target")) / 2f)), (int) (h * 0.85), 0xff0000, false);
