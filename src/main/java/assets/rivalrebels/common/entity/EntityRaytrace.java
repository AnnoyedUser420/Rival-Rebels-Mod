        ...
        if (MOP != null) {
            if (MOP.entityHit == null) {
                if (!worldObj.isRemote)
                    worldObj.spawnEntityInWorld(new EntityLightningLink(worldObj, this, getDistance(MOP.hitVec.xCoord, MOP.hitVec.yCoord, MOP.hitVec.zCoord)));
                ...
                if (!worldObj.isRemote)
                    worldObj.spawnEntityInWorld(new EntityLightningLink(worldObj, this, getDistanceToEntity(MOP.entityHit)));
