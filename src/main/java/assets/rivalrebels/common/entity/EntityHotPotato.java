...
public class EntityHotPotato extends EntityThrowable
{
	...
	public void onUpdate()
	{
		...
		if (!worldObj.isRemote)
		{
			...
			Entity var4 = null;
			List var5 = this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.getCollisionBoundingBox().addCoord(this.motionX, this.motionY, this.motionZ).expand(1.0D, 1.0D, 1.0D));
			double var6 = 0.0D;
			...
			if (worldObj.getBlockState(new BlockPos((int)posX, (int)posY, (int)posZ)) == Blocks.water)
			{
				motionY += 0.06f;
			}
		}
