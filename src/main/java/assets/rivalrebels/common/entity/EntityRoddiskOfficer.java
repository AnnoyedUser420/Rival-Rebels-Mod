...
public class EntityRoddiskOfficer extends EntityInanimate
{
	...
	public void onUpdate()
	{
		...
		if (var3 != null)
		{
			...
			{
				RivalRebels.flare.onBlockDestroyedByPlayer(worldObj, var3.getBlockPos(), Blocks.air.getDefaultState());
			}
			...
			else
			{
				...
				{
					worldObj.setBlockState(var3.getBlockPos(), Blocks.air.getDefaultState());
				}
