...
public class TileEntityTsarBomba extends TileEntity implements IInventory {
    ...
    public void updateEntity() {
        ...
        hasExplosive = getStackInSlot(19) != null;// getStackInSlot(19).func_150998_b(RivalRebels.timedbomb);
        ...
        if (countdown % 20 == 0 && countdown <= 200 && RivalRebels.nuclearBombCountdown > 10)
            RivalRebelsSoundPlayer.playSound(worldObj, 14, 0, xCoord, yCoord, zCoord, 100);
