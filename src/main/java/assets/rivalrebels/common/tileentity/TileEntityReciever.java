    ...
    private boolean isValidTarget(Entity e) {
        if (e == null) return false;
            ...
            if (p.capabilities.isCreativeMode) return false;
                ...
                RivalRebelsPlayer rrp = RivalRebels.round.rrplayerlist.getForName(e.getCommandSenderName());
            ...
            return (kMobs && (e instanceof EntityRhodes || (e instanceof EntityMob && !(e instanceof EntityAnimal) && !(e instanceof EntityBat) && !(e instanceof EntityVillager) && !(e instanceof EntitySquid)) || e instanceof EntityGhast));
    }
