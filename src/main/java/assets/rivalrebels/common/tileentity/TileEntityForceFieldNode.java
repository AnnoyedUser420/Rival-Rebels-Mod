...
public class TileEntityForceFieldNode extends TileEntityMachineBase {
    ...
    public AxisAlignedBB getRenderBoundingBox() {
        ...
        switch (meta) {
            case 2:
                return AxisAlignedBB.getBoundingBox(xCoord + 0.5f - t, yCoord + 0.5f - h, zCoord - l, xCoord + 0.5f + t, yCoord + 0.5f + h, zCoord);
            case 3:
                return AxisAlignedBB.getBoundingBox(xCoord + 0.5f - t, yCoord + 0.5f - h, zCoord + 1f, xCoord + 0.5f + t, yCoord + 0.5f + h, zCoord + 1f + l);
            case 4:
                return AxisAlignedBB.getBoundingBox(xCoord - l, yCoord + 0.5f - h, zCoord + 0.5f - t, xCoord, yCoord + 0.5f + h, zCoord + 0.5f + t);
            case 5:
                return AxisAlignedBB.getBoundingBox(xCoord + 1f, yCoord + 0.5f - h, zCoord + 0.5f - t, xCoord + 1f + l, yCoord + 0.5f + h, zCoord + 0.5f + t);
            default:
